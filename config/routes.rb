Rails.application.routes.draw do
  ...
  resources :mailings
  get 'mailings/:slug/verzenden', to: 'mailings#send_mailing'
  post 'mailings', to: 'mailings#subscribe'
  get 'mailings/:uuid/afmelden', to: 'mailings#unsubscribe'
  ...
  get 'nieuwsbrieven', to: redirect('mailings')
end
